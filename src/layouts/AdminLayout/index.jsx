 ...
 *    - MobileHeader: Visible seulement sur mobile
 *    - NavBar: Barre de navigation supérieure (toujours visible)
 *    - Navigation: Sidebar latérale (navigation principale)
 *    - Breadcrumb: Fil d'Ariane pour l'orientation
 *    - Outlet: Contenu dynamique des routes
 * 
 * 2. Responsive Design:
 *    - Gestion automatique du menu sur différentes tailles d'écran
 *    - Classes CSS conditionnelles sur le body
 *    - Breakpoints: 992px et 1024px
 * 
 * 3. Performance:
 *    - Suspense pour le chargement asynchrone des routes
 *    - Loader pendant le chargement
 *    - Effets optimisés avec les dépendances appropriées
 * 
 * 4. Accessibilité:
 ...
 *    - Manipulation directe du DOM (body.classList) dans useEffect
 *    - Nettoyage des effets pour éviter les effets secondaires
 *    - Gestion des redimensionnements de fenêtre
 * 
 * Exemple d'utilisation dans le routage:
 * 
